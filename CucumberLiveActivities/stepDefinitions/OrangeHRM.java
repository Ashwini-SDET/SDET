...
public class OrangeHRM {
	...
	@Given("^Navigate to the Recruitment Page$")
	public void navigateToRecruitmentpage() throws Throwable {
		Thread.sleep(6000);	
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menu_recruitment_viewRecruitmentModule")));
		driver.findElement(By.id("menu_recruitment_viewRecruitmentModule")).click();
	}
	...
	public void fillJobForm() throws Throwable{
		...
		driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("Ash Sandy");
	...
	public void closeFirefoxBrowser() throws Throwable{
		driver.quit();
	...
	public void candidateForm() throws Throwable{
		Thread.sleep(6000);
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("Veer");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("Shira");
		driver.findElement(By.id("addCandidate_email")).sendKeys("test100@gmail.com");
		driver.findElement(By.id("addCandidate_contactNo")).sendKeys("8000098998");
		...
		public void uploadResume() throws Throwable{
			...
			uploadElement.sendKeys("C:\\Users\\AshwiniGurushantavee\\eclipse-workspace\\CucumberLiveProjects\\src\\test\\resources\\Resume.docx");
		}
		@And("^Click Save$")
		...
		public void validateCandidature() throws Throwable{
			...
			driver.findElement(By.id("candidateSearch_candidateName")).sendKeys("Veer Shira");
			driver.findElement(By.id("btnSrch")).click();
			Thread.sleep(5000);
			...
			String JobTitle1 = driver.findElement(By.linkText("Veer Shira")).getText();
	    	Assert.assertEquals(JobTitle1, "Veer Shira"); 
		}
