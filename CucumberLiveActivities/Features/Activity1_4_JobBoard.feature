...
@TestCaseFour
Scenario: Posting a job using Examples
...
|glctest3@hotmail.com|SDET Developer Tester|Bengaluru|We want a tester who have knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing|glctestjob2@gmail.com|IBM India Pvt Ltd|