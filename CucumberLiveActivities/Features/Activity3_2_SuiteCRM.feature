...
Scenario: Create leads using parameterization
    ...
    When Fill in the necessary details to create lead accounts using the values passed from the Feature file as "Mr." and "Kiran" and "Raj" and "gglctest@hotmail.com"
