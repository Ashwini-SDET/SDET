...
Scenario: Posting a job using parameterization
    ...
    When User provides the information "glcctest1@gmail.com" , "SDET Tester" , "Bangalore" , "We want a tester who have knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing" , "glcctestjob@gmail.com" and "IBM India Pvt Ltd"  
    Then Click submit
